                                ...
                                <Button asChild className="cursor-pointer">
                                    <Link href={create.url()}>
                                        ...
                                        <span className="hidden sm:inline">
                                            {t(
                                                'convention.index.create_button',
                                            )}
                                        </span>
                                        <span className="sm:hidden">
                                            {t('convention.index.create_short')}
                                        </span>
                                    </Link>
                                </Button>
                            </TooltipTrigger>
                            <TooltipContent>
                                {t('convention.index.create_tooltip')}
                            </TooltipContent>
                        </Tooltip>
                    )}
                </div>
                ...
                {conventions.length === 0 ? (
                    <div className="flex flex-1 flex-col items-center justify-center rounded-xl border border-dashed border-border p-8 text-center">
                        ...
                        {canCreateConvention && (
                            ...
                            >
                                <Link href={create.url()}>
                                    {t('convention.index.empty_create')}
                                </Link>
                            </Button>
                        )}
                    </div>
