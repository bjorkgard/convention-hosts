...
export default function SectionsIndex({
    ...
    function handleAdd(e: React.FormEvent) {
        e.preventDefault();
        addForm.post(
            store.url({ convention: convention.id, floor: floor.id }),
            {
                onSuccess: () => {
                    addForm.reset();
                            ...
                            <TooltipTrigger asChild>
                                ...
                                >
                                    ...
                                    <span className="hidden sm:inline">
                                        {t('section.index.add_button')}
                                    </span>
                                    <span className="sm:hidden">
                                        {t('section.index.add_short')}
                                    </span>
                                </Button>
                            </TooltipTrigger>
                            <TooltipContent>
                                {t('section.index.add_tooltip')}
                            </TooltipContent>
                        </Tooltip>
                    )}
                </div>
                        ...
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                {t('section.modal.add_description', {
                                    convention: floor.name,
                                })}
                            </DialogDescription>
                        </DialogHeader>
                        <div className="grid gap-3 py-4">
                            <div className="grid gap-2">
                                <Label htmlFor="add-section-name">
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="add-section-seats">
                                ...
                                />
                                <InputError
                                    message={addForm.errors.number_of_seats}
                                />
                            </div>
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="add-section-info">
                                ...
                                />
                                <InputError
                                    message={addForm.errors.information}
                                />
                            </div>
                        </div>
                        <DialogFooter>
