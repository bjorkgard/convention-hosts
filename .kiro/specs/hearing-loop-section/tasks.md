...
- [ ] 1. Database migration and Section model
  - [ ] 1.1 Create migration to add `hearing_loop` column to sections table
  ...
  - [ ] 1.2 Update Section model fillable and casts
  ...
  - [ ] 1.3 Write property test for hearing_loop round-trip persistence
...
- [ ] 2. Backend validation and search filter
  - [ ] 2.1 Add `hearing_loop` validation rule to form requests
  ...
  - [ ] 2.2 Write property test for hearing_loop validation
  ...
  - [ ] 2.3 Add `hearing_loop` filter to SearchController
  ...
  - [ ] 2.4 Write property test for search filter
...
- [ ] 4. Frontend type and UI components
  - [ ] 4.1 Add `hearing_loop` to TypeScript Section type
    - Add `hearing_loop: boolean` to `Section` interface in `resources/js/types/convention.ts` after `handicap_friendly`
    - _Requirements: 6.1_

  - [ ] 4.2 Add "Hearing loop" checkbox to section modal
  ...
  - [ ] 4.3 Add "Hearing loop" filter to search page
...
- [ ] 5. Data exports
  - [ ] 5.1 Add `hearing_loop` to all export formats
  ...
  - [ ] 5.2 Write property test for export includes hearing_loop
...
- [ ] 6. Factory and daily reset verification
  - [ ] 6.1 Update SectionFactory with `hearing_loop`
  ...
  - [ ] 6.2 Write property test for daily reset preserves hearing_loop
