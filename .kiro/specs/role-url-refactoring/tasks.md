...
- [x] 4. Backend policies, actions, and services
  - [x] 4.1 Update all policies
  ...
  - [x] 4.2 Update CreateConventionAction
  ...
  - [x] 4.4 Update AttendanceReportService
  ...
  - [x] 4.5 Update ConventionController show method
  ...
  - [x] 4.6 Update HandleInertiaRequests middleware
  ...
  - [x] 4.7 Update StoreUserRequest and UpdateUserRequest
  ...
  - [x] 4.8 Write property tests for policies and services (backend)
