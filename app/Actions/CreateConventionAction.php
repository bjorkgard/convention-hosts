...
{
    /**
     * Create a new convention with the creator assigned as Owner and Administrator.
     *
    ...
    public function execute(array $data, User $creator): Convention
    {
        return DB::transaction(function () use ($data, $creator) {
            // Create the convention (tokens auto-generated by Convention model boot method)
            ...
            // Assign Owner and Administrator roles
